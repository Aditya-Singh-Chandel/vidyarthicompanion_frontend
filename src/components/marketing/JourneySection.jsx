...
const STEPS = [
  {
    step: '01',
    title: 'Land & Discover',
    desc: 'Hero scroll reveals the Midnight Monsoon theme',
    href: '/',
    icon: Sparkles,
    preview: 'surface-ink',
    label: 'Home',
  },
  {
    ...
    desc: 'Cards expand on hover — masonry grid of capabilities',
    href: '/features',
    icon: Users,
    preview: 'bg-[var(--mist)]',
    label: 'Features',
  },
  {
    ...
    desc: 'Forms, toggles, and live progress indicators',
    href: '/dashboard',
            ...
            return (
              <ScrollReveal key={item.step} delay={i * 120}>
                <Link href={item.href} className="group block">
                  <div className="card-base overflow-hidden p-0 transition-all duration-500 group-hover:ring-2 group-hover:ring-[var(--teal)]">
                    <div className={`${item.preview} relative h-36 overflow-hidden p-4`}>
                      <div className="orb orb-teal -left-4 top-0 h-24 w-24" />
                      <div className="orb orb-saffron right-0 bottom-0 h-20 w-20" />
                      <div className="relative flex h-full flex-col justify-between">
                        <span className="text-mono-data text-xs font-bold text-[var(--teal)]">{item.step}</span>
                    ...
                    <div className="p-5">
                      ...
                      <span className="mt-3 inline-flex items-center gap-1 text-sm font-semibold text-[var(--teal)] transition-all group-hover:gap-2">
